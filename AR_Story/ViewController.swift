    ...
    func authorizationState(){
         SFSpeechRecognizer.requestAuthorization { authStatus in
             ...
             OperationQueue.main.addOperation {
                    switch authStatus {
                        case .authorized:
                             self.TextViewOfStory.text = "User authorized access to speech recognition"
                        case .denied:
                             self.TextViewOfStory.text = "User denied access to speech recognition"
                        case .restricted:
                             self.TextViewOfStory.text = "Speech recognition restricted on this device"
                        case .notDetermined:
                             self.TextViewOfStory.text = "Speech recognition not yet authorized"
    ...
    private func startRecording() throws {
        ...
        recognitionTask = speechRecognizer.recognitionTask(with: recognitionRequest) { result, error in
            ...
            if let result = result {
                ...
                self.TextViewOfStory.text = result.bestTranscription.formattedString
